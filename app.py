...
def index():
  ...
  """
  response = {
    "filter_available": filters_available,
...
def image_filter(filter):
  """
  TODO
  1. Check if the provided filter is available, if not, return an error
  2. Check if a file is been provided in the POST request, if not, return an error
